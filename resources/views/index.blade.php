...
<div style="display: none;" id="gallery"></div>
    <!-- <div class="row"> -->
        ...
        <ul class="nav nav-tabs justify-content-center" role="tablist">
                    ...
                    <li class="nav-item">
                            <a class="nav active show" href="#link0">
                   ...
                   <i class="bi bi-people-fill"></i>
                            ...
                            <p style="font-weight:bold; font-size:150%;">Misión</p>
                            </a>
                        </li>
                        <li class="nav-item">
                        <div class="icon icon-success">
                   <i class="bi bi-eye-fill"></i>
                            ...
                            <p style="font-weight:bold; font-size:150%;">Visión</p>
                            </a>
                        </li>
                        <li class="nav-item">
                        <div class="icon icon-warning">
                   <i class="bi bi-person-hearts"></i>
                            ...
                            <p style="font-weight:bold; font-size:150%;">Valores</p>
                            </a>
                        </li>
                    ...
                    <div class="tab-pane active show" id="link0">
